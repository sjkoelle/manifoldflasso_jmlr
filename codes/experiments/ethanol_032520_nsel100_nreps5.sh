#!/bin/bash
#SBATCH --job-name eth_032520      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH -o myscript_emdamhm%j.out    # File to which STDOUT will be written
#SBATCH -e myscript_emdamhm%j.err    # File to which STDERR will be written
...
python ethanol_032520_nsel100_nreps5.py
