#!/bin/bash
#SBATCH --job-name tolpcaangles_tangent      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
python toluenepca_multirun_tangent_2.py
