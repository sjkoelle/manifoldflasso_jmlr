...
new_MN = True
new_grad = True
savename = 'ethanol_110120'
savefolder = 'ethanol'
loadfolder = 'ethanol'
loadname = 'ethanol_110120'
if new_MN == True:
...
fig.savefig(folder + '/dot_distribution.png')

src = workingdirectory + '/codes/experiments/ethanol_032520_nsel100_nreps5.py'
