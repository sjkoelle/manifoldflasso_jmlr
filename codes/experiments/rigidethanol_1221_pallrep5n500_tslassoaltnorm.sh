#!/bin/bash
#SBATCH --job-name rigidethanol      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH -o myscript_rigidethanol500%j.out    # File to which STDOUT will be written
#SBATCH -e myscript_rigidethanol500%j.err    # File to which STDERR will be written
...
python -u rigidethanol_1221_pallrep5n500_tslassoaltnorm.py > re_500_tslasso_alt.out