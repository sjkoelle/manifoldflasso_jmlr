#!/bin/bash
#SBATCH --job-name repcaangles      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH -o myscript_repca%j.out    # File to which STDOUT will be written
#SBATCH -e myscript_repca%j.err    # File to which STDERR will be written
...
python rigidethanolpca_multirun.py
