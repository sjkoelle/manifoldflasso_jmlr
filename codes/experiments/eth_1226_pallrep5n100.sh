#!/bin/bash
#SBATCH --job-name e1226      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH -o my_e1226%j.out    # File to which STDOUT will be written
#SBATCH -e my_e1226%j.err    # File to which STDERR will be written
...
python eth_1226_pallrep5n100.py
