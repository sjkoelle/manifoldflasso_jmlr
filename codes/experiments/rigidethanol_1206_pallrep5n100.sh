#!/bin/bash
#SBATCH --job-name re_6_norm      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH -o myscript_renorm%j.out    # File to which STDOUT will be written
#SBATCH -e myscript_renorm%j.err    # File to which STDERR will be written
...
python -u rigidethanol_1206_pallrep5n100.py > re_100all5norm.out
