...
def get_grads(experiment, Mpca, Mangles, N, selected_points):
    ...
    return (df_M, dg_M, dg_w, dg_w_pca, dgw_norm,tangent_bases)
...
new_MN = True
new_grad = True
savename = 'malonaldehyde_010521_n100pallnrep5'
savefolder = 'malonaldehyde'
loadfolder = 'malonaldehyde'
loadname = 'malonaldehyde_010521_n100pallnrep5'
if new_MN == True:
...
with open(workingdirectory + '/untracked_data/embeddings/' + savefolder + '/' + savename + 'replicates_small.pkl' ,
         'wb') as output:
     pickle.dump(replicates_small, output, pickle.HIGHEST_PROTOCOL)
