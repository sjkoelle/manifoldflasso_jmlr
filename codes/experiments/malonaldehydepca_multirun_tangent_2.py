...
diffusion_time = 0.47 #diffusion time controls gaussian kernel radius per gradients paper
...
new_MN = False
savename = 'malonaldehyde_013120'
savefolder = 'malonaldehyde'
loadname = 'malonaldehyde_013020'
...
if new_MN == True:
    ...
    with open(workingdirectory + '/untracked_data/embeddings/' + savefolder + '/' + savename + '.pkl' ,'wb') as output:
...
src = workingdirectory + '/codes/experiments/malonaldehydepca_multirun_tangent_2.py'
