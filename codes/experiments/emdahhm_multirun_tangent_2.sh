#!/bin/bash
#SBATCH --job-name emdahhm      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH -o myscript_emdahhm%j.out    # File to which STDOUT will be written
#SBATCH -e myscript_emdahhm%j.err    # File to which STDERR will be written
...
python emdahhm_multirun_tangent_2.py
