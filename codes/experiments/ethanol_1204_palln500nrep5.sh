#!/bin/bash
#SBATCH --job-name e      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH -o myscript_e500%j.out    # File to which STDOUT will be written
#SBATCH -e myscript_e500%j.err    # File to which STDERR will be written
...
python -u ethanol_1204_palln500nrep5.py > e_500all5_2.out
