#!/bin/bash
#SBATCH --job-name dimeth      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH -o myscript_dimeth%j.out    # File to which STDOUT will be written
#SBATCH -e myscript_dimeth%j.err    # File to which STDERR will be written
...
python dimethylfuran_multirun_tangent_2.py
