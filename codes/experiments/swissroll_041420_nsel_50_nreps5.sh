#!/bin/bash
#SBATCH --job-name sw      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH -o myscript_sw%j.out    # File to which STDOUT will be written
#SBATCH -e myscript_sw%j.err    # File to which STDERR will be written
