...
nsel = 2500 #number of points to analyze with lasso
...
new_MN = True
new_grad = True
savename = 'rigidethanol_120720_samgl_n2500_pall_nrep1'
savefolder = 'rigidethanol'
loadfolder = 'rigidethanol'
loadname = 'rigidethanol_120720_samgl_n2500_pall_nrep1'
if new_MN == True:
