...
#SBATCH -o myscript_mal500%j.out    # File to which STDOUT will be written
#SBATCH -e myscript_mal500%j.err    # File to which STDERR will be written
...
python -u malonaldehyde_1221_pallrep5n500_tslassoaltnorm.py > mal_500_tslasso_alt.out