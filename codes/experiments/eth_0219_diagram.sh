#!/bin/bash
#SBATCH --job-name eth_diagram      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH -o myscript_eth_diagram%j.out    # File to which STDOUT will be written
#SBATCH -e myscript_eth_diagram%j.err    # File to which STDERR will be written
...
python -u eth_0219_diagram.py > eth_diagram_0219.out