#!/bin/bash
#SBATCH --job-name malpcaangles_tangent      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH -o myscript_mpca%j.out    # File to which STDOUT will be written
#SBATCH -e myscript_mpca%j.err    # File to which STDERR will be written
...
python malonaldehydepca_multirun_tangent_2.py
