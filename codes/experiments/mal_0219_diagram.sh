#!/bin/bash
#SBATCH --job-name mal_diagram      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH -o myscript_mal_diagram%j.out    # File to which STDOUT will be written
#SBATCH -e myscript_mal_diagram%j.err    # File to which STDERR will be written
...
python -u mal_0219_diagram.py > mal_diagram_0219.out