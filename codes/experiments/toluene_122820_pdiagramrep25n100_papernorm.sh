#!/bin/bash
#SBATCH --job-name tol_pn      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH -o myscript_tol%j.out    # File to which STDOUT will be written
#SBATCH -e myscript_tol%j.err    # File to which STDERR will be written
...
python toluene_122820_pdiagramrep16n100_papernorm.py > tol_1228_papernorm.out
