...
new_MN = True
new_grad = True
savename = 'rigidethanol_032520_4'
savefolder = 'rigidethanol'
loadfolder = 'rigidethanol'
loadname = 'rigidethanol_032520_4'
nreps = 25
atoms4,p = get_atoms_4(9,ii,jj)
folder = workingdirectory + '/Figures/rigidethanol/dim4' + now + 'n' + str(n) + 'nsel' + str(nsel) + 'nreps' + str(nreps)
os.mkdir(folder)
